...
public class RunnerClass 
{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		for(int i=0;i<pendingRenewalLeases.length;i++)
		{
		  ...
		  if(company.contains("Austin")||company.contains("California")||company.contains("Chattanooga")||company.contains("Chicago")||company.contains("Colorado")||company.contains("Kansas City"))
	     {
