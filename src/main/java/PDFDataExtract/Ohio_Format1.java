...
public class Ohio_Format1 
{
	...
	//public static void main(String args[]) throws Exception
	{
	  ...
	  //Resident Benefits Package 
	    if(text.contains(PDFAppConfig.Ohio_Format1.residentBenefitsPackageAddendumCheck))
	    {
	    ...
	    try
	    {
	    	String[] earlyTerminationRaw = text.substring(text.indexOf(PDFAppConfig.Ohio_Format1.AB_earlyTerminationFee_Prior)+PDFAppConfig.Ohio_Format1.AB_earlyTerminationFee_Prior.length()).split(" ");
