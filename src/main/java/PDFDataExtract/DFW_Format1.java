...
public class DFW_Format1 
{
	...
	//public static void main(String args[]) throws Exception
	{
	  ...
	  //Resident Benefits Package 
	    if(text.contains(PDFAppConfig.DFW_Format1.residentBenefitsPackageAddendumCheck))
	    {
	    ...
	    try
	    {
	    	String[] earlyTerminationRaw = text.substring(text.indexOf(PDFAppConfig.DFW_Format1.AB_earlyTerminationFee_Prior)+PDFAppConfig.DFW_Format1.AB_earlyTerminationFee_Prior.length()).split(" ");
