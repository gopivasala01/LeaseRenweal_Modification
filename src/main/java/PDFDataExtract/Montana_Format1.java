...
public class Montana_Format1 
{
	...
	//public static void main(String args[]) throws Exception
	{
	  ...
	  //Resident Benefits Package 
	    ...
	    try
	    {
	    	String[] earlyTerminationRaw = text.substring(text.indexOf(PDFAppConfig.Montana_Format1.AB_earlyTerminationFee_Prior)+PDFAppConfig.Montana_Format1.AB_earlyTerminationFee_Prior.length()).split(" ");
