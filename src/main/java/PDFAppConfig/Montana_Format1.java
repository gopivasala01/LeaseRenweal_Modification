...
{
	public static String AB_commencementDate_Prior = "Commencement Date:";
	...
	public static String AB_commencementDate_Prior2 = "Lease commences on ";
		...
		public static String AB_expirationDate_After = "B. Occupancy";
		...
		public static String residentBenefitsPackage_New = "TOTAL CHARGE TO TENANT $";
		public static String residentBenefitsPackageTaxAmount_New = "(Inclusive of $";
